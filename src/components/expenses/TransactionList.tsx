...
/**
 * Componente que muestra una lista de transacciones sin botones de editar/borrar
          ...
          <div className="divide-y divide-gray-100">
            {filteredExpenses.map((expense) => (
              <div key={expense.id} className="flex items-center justify-between py-4 hover:bg-gray-50 transition-colors duration-150">
                ...
                <div className="flex items-center">
                  <p className={`text-base font-medium ${expense.isIncome ? 'text-green-600' : 'text-red-600'}`}>
